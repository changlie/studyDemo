...
public class SocketProcessor implements Runnable {
    ...
    public void executeCycle() throws IOException {
        //处理新请求,　将新socketChannel 注册到　selector
        takeNewSockets();
        //　socket 列表　读取　有数据可读　socket数据
        readFromSockets();
        // 发送　响应讲求的数据
        writeToSockets();
    }
    ...
    //　执行　读取数据操作
    private void doReadFromSocket(SelectionKey key) throws IOException {
